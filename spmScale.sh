...
gm=$(3dROIstats -mask /mnt/BIAC/munin2.dhe.duke.edu/Hariri/DNS.01/Analysis/Max/templates/DNS500/DNS500template_MNI_BrainExtractionMask_2mm.nii.gz ${outDir}/tmp.mean.epiWarped_blur6mm.nii.gz)
